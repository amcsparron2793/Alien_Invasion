...
class Scoreboard:
    ...
    def prep_high_score(self):
        ...
        if path.isfile('./Current_HighScore.txt'):
            with open('./Current_HighScore.txt') as file:
                self.stats.high_score = file.readline(1)
            file.close()
        elif not path.isfile('./Current_HighScore.txt'):
            pass
